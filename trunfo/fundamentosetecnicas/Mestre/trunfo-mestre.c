...
void comparar(int populacao1, int populacao2, float areakm1, float areakm2, float pib1, float pib2, int pontos1, int pontos2, float densidade1, float densidade2, float pibpcap1, float pibpcap2, float superpoder1, float superpoder2){
...
void criarcartao(){
  ...
  comparar(populacao, populacao2, areakm, areakm2, pib, pib2, pontoturistico, pontoturistico2, densidade, densidade2, pibpercapita, pibpercapita2, superpoder1, superpoder2);
}
